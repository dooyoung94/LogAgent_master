...
| [OpenRCA 1.0](https://github.com/microsoft/OpenRCA) | 335 enterprise failures, over 68 GB, distributed through Google Drive | root component, reason, and time | CONDITIONAL | heavy external LLM RCA validation; Telecom lacks logs and topology gold is limited |
